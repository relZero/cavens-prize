$(function () {
    ...
    excelToJsonInit.GetData("http://localhost:3007/tableData?_sort=staffSort", "", function (data) {
    ...
    function deleteDataAction($this) {
        ...
        excelToJsonInit.GetData("http://localhost:3007/tableData?_sort=staffSort", {id: thisId}, function (data) {
            var staffData = data[0];
            excelToJsonInit.DeleteData("http://localhost:3007/tableData/", staffData.id, function () {
                $this.remove();
                excelToJsonInit.PostData("http://localhost:3005/deleteTable", {
                    id: staffData.id,
