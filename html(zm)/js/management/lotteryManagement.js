$(function () {
    ...
    excelToJsonInit.GetData("http://localhost:3003/personnelData?_sort=staffSort", "", function (data) {
    ...
    function deleteDataAction($this) {
        ...
        excelToJsonInit.GetData("http://localhost:3003/personnelData?_sort=staffSort", {id: thisId}, function (data) {
            var staffData = data[0];
            excelToJsonInit.DeleteData("http://localhost:3003/personnelData/", staffData.id, function () {
                $this.remove();
                excelToJsonInit.PostData("http://localhost:3005/deleteData", {
                    id: staffData.id,
