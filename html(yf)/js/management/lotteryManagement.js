$(function () {
    ...
    excelToJsonInit.GetData(jsonDataUrl + ":3003/personnelData?_sort=staffSort", "", function (data) {
    ...
    function deleteDataAction($this) {
        ...
        excelToJsonInit.GetData(jsonDataUrl + ":3003/personnelData?_sort=staffSort", {id: thisId}, function (data) {
            var staffData = data[0];
            excelToJsonInit.DeleteData(jsonDataUrl + ":3003/personnelData/", staffData.id, function () {
                $this.remove();
                excelToJsonInit.PostData(jsonDataUrl + ":3005/deleteData", {
                    id: staffData.id,
