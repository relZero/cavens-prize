$(function () {
    ...
    excelToJsonInit.GetData(jsonDataUrl + ":3005/deleteData?_sort=staffSort", "", function (data) {
    ...
    function backDataAction($this) {
        ...
        excelToJsonInit.GetData(jsonDataUrl + ":3005/deleteData?_sort=staffSort", {id: thisId}, function (data) {
            ...
            excelToJsonInit.DeleteData(jsonDataUrl + ":3005/deleteData/", staffData.id, function () {
                $this.remove();
                excelToJsonInit.PostData(jsonDataUrl + ":3003/personnelData", {
                    id: staffData.id,
