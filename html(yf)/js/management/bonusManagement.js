$(function () {
    ...
    excelToJsonInit.GetData(jsonDataUrl + ":3006/bonusData?_sort=staffSort", "", function (data) {
    ...
    function deleteDataAction($this) {
        ...
        excelToJsonInit.GetData(jsonDataUrl + ":3006/bonusData?_sort=staffSort", {id: thisId}, function (data) {
            var staffData = data[0];
            excelToJsonInit.DeleteData(jsonDataUrl + ":3006/bonusData/", staffData.id, function () {
                $this.remove();
                excelToJsonInit.PostData(jsonDataUrl + ":3005/deleteBonus", {
                    id: staffData.id,
